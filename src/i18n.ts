...
const translations = {
  ...
  "privacy.body": { en: "This application is intended for internal use only. Customer names are stored in our database with order details. Email addresses and phone numbers are not stored in our database; this information appears only in order confirmation emails, which are processed by a third-party email provider (Resend) and retained for up to 30 days before deletion. To learn more, please contact info@synergygroupapparel.ca.", fr: "Cette application est réservée à un usage interne. Le nom du client est conservé dans notre base de données, avec le détail de la commande. Les adresses courriel et les numéros de téléphone ne sont pas conservés dans notre base de données; ces renseignements figurent uniquement dans les courriels de confirmation de commande, traités par un fournisseur de courriel tiers (Resend) et conservés pendant un maximum de 30 jours avant leur suppression. Pour en savoir plus, veuillez communiquer avec info@synergygroupapparel.ca." },
  // Header nav
  ...
  "login.portalsubtitle": { en: "Select a portal", fr: "Sélectionnez un portail" },
  ...
  "tablet.title": { en: "Mobile & tablet coming soon", fr: "Mobile et tablette bientôt disponibles" },
  "tablet.sub": { en: "Please visit on desktop for now.", fr: "Veuillez consulter sur ordinateur pour l'instant." },
  ...
  "cat.Safety": { en: "Safety Wear", fr: "Vêtements de sécurité" },
