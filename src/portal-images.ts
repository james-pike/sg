...
export const PORTAL_SKU_IMAGES: Record<string, Record<string, PortalImageOverride>> = {
  ...
  portal1: {
    ...
    "SG-14": { img: "/portals/i8502-as.webp", imgs: ["/portals/i8502-as.webp"] },
  ...
  portal2: {
    ...
    "SG-14": { img: "/portals/i8502-cf.webp", imgs: ["/portals/i8502-cf.webp"] },
  ...
  portal3: {
    ...
    "SG-14": { img: "/portals/i8502-ws.webp", imgs: ["/portals/i8502-ws.webp"] },
  ...
  portal4: {
    ...
    "SG-14": { img: "/portals/i8502-ps.webp", imgs: ["/portals/i8502-ps.webp"] },
