...
export const PORTAL_SKU_IMAGES: Record<string, Record<string, PortalImageOverride>> = {
  ...
  portal1: {
    ...
    "SG-19": { img: "/portals/19534-as.webp", imgs: ["/portals/19534-as.webp"] },
    "SG-20": { img: "/portals/g8800-as.jpg", imgs: ["/portals/g8800-as.jpg"] },
    "SG-21": { img: "/portals/17745-as.webp", imgs: ["/portals/17745-as.webp"] },
  },
  portal2: {
  ...
  portal4: {
    ...
    "SG-19": { img: "/portals/19534-ps.webp", imgs: ["/portals/19534-ps.webp"] },
    "SG-20": { img: "/portals/g8800-ps.jpg", imgs: ["/portals/g8800-ps.jpg"] },
    "SG-21": { img: "/portals/17745-ps.webp", imgs: ["/portals/17745-ps.webp"] },
  },
};
