...
export default component$(() => {
  ...
  const product = useComputed$(() => {
    const p = allProducts.find((p) => p.sku === loc.params.sku);
    // Swap in this portal's image(s) for the SKU (same product otherwise).
    return p ? portalizeProduct(p, loginType.value) : null;
  });
